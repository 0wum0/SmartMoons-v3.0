...
// DB_VERSION_REQUIRED is defined in includes/constants.php – do not redefine here.

// $databaseConfig is available from the Database::__construct() scope that include()s this file.
if (!defined('DB_NAME')) {
	define('DB_NAME', (string)($databaseConfig['dbname'] ?? ''));
}
