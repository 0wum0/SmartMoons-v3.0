...
$LNG['intro_welcome']			= 'Herzlich Willkommen beim SmartMoons!';
$LNG['intro_text']				= 'SmartMoons ist ein moderner Fork von 2Moons, einem der besten Klone von OGame.<br>SmartMoons ist die neueste und stabilste Version je entwickelt wurde. SmartMoons glänzt durch moderne PHP 8.3 Kompatibilität, PDO Sicherheit, Twig Templates und futuristisches Dark Sci-Fi Interface. Wir hoffen immer besser zu sein als ihre Erwartungen.<br><br>Das Installations-System führt Sie durch die Installation, oder Upgrade auf einer vorherigen Version auf die neueste ein. Jede Frage, ein Problem zögern Sie bitte nicht, unsere Entwicklung und Unterstützung zu ersuchen.<br><br>SmartMoons ist ein OpenSource-Projekt und ist unter MIT Lizenz lizenziert. Zur Lizenz klicken Sie bitte im Menu auf die entsprechenden Menüpunkt.<br><br>Bevor die Installation gestartet werden kann, wird vorher ein kleiner Test durchgeführt, ob sie die Mindestanforderungen unterstützen.';
$LNG['intro_upgrade_head']		= 'SmartMoons schon installiert?';
$LNG['intro_upgrade_text']		= '<p>Du hast SmartMoons bereits installiert und möchtest einfach updaten?</p><p>Hier kann du deine alte Datenbank mit wenigen klicks aktualisieren!</p>';
...
$LNG['upgrade_required_rev']	= 'Der Updater kann nur ab Revision r2579 (SmartMoons v1.7) oder höher updaten.';
...
$LNG['req_desc']				= 'Bevor die Installation fortgesetzt werden kann, wird SmartMoons einige Tests zu deiner Server-Konfiguration und deinen Dateien durchführen, um sicherzustellen, dass du SmartMoons installieren und benutzen kannst. Bitte lies die Ergebnisse aufmerksam durch und fahre nicht weiter fort, bevor alle erforderlichen Tests bestanden sind. Falls du irgendeine der Funktionen, die unter den optionalen Modulen aufgeführt sind, nutzen möchtest, solltest du sicherstellen, dass die entsprechenden Tests auch bestanden werden.';
$LNG['reg_yes']					= 'Ja';
$LNG['reg_no']					= 'Nein';
...
$LNG['req_php_need_desc']		= '<strong>Voraussetzung</strong> — PHP ist die Serverseitige Sprache, in der SmartMoons geschrieben ist. Damit SmartMoons ohne Einschränkungen funktioniert, wird die PHP Version 8.3 vorausgesetzt.';
...
$LNG['reg_global_desc']			= 'SmartMoons wird auch funktionieren, wenn diese Einstellung aktiviert ist. Allerdings wird aus Sicherheitsgründen empfohlen, register_globals in der PHP-Installation zu deaktivieren, falls dies möglich ist.';
$LNG['req_ftp_head']			= 'Eingabe der Zugangsdaten für FTP';
$LNG['req_ftp_desc']			= 'Geben Sie Ihre FTP Daten ein, damit SmartMoons automatisch die Probleme beheben kann. Alternativ können Sie auch manuell die Schreibrechte vergeben.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'Benutzername';
$LNG['req_ftp_password']		= 'Kennwort';
$LNG['req_ftp_dir']				= 'Installationspfad zu SmartMoons';
...
$LNG['step1_desc']				= 'Nachdem nun festgestellt wurde, dass SmartMoons auf deinem Server betrieben werden kann, musst du noch einige Informationen angeben. Wenn du nicht weißt, wie die Verbindungsdaten für deine Datenbank lauten, kontaktiere bitte als erstes deinen Webhosting-Provider oder wende dich an die SmartMoons Support-Foren. Wenn du Daten eingibst, prüfe diese bitte sorgfältig, bevor du fortfährst.';
...
$LNG['step3_desc']				= 'Die von SmartMoons genutzten Datenbank-Tabellen wurden nun erstellt und mit einigen Ausgangswerten gefüllt. Geh weiter zum nächsten Schritt, um die Installation von SmartMoons abzuschließen.';
...
$LNG['step6_desc']				= 'Du hast SmartMoons erfolgreich installiert.';
$LNG['step6_info_head']			= 'Starte mit SmartMoons durch!';
...
$LNG['sql_welcome']				= 'Herzlich Willkommen zu SmartMoons v';
