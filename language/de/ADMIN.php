...
$LNG['bo_bbb_title_3'] = 'Suspension System &bull; Dieser Spieler ist bereits gesperrt';
...
$LNG['se_min_build_time_info'] = 'Hier stellst du die Mindestbauzeit für Gebäude, Forschungen sowie Flotten und Verteidigung ein. Standartmäßig ist dies auf 1 Sekunde gesetzt.<br>Wenn hier eine 0 eingetragen wird, wird dies deaktivert<br>Es entstehen Bugs, wenn diese deaktivert wird!';
...
$LNG['ac_moons_no'] = '(Kein Mond)';
$LNG['ac_urlnow'] = 'URL: ';
$LNG['ac_time_destruyed'] = 'Datum der Zerstörung';
$LNG['ac_isnodestruyed'] = '(Bisher wurden keine Monde zerstört)';
$LNG['ac_no_alliance'] = '(Keine Allianz)';
...
$LNG['ac_note_k'] = '<table><tr><th width=10%>T+</th><th>Billiarde</th></tr><tr><th width=10%>T</th><th>Billion</th></tr><tr><th width=10%>B</th><th>Milliarde</th></tr><tr><th width=10%>M</th><th>Million</th></tr><tr><th width=10%>K</th><th>Tausend</th></tr></table>';
...
$LNG['sp_admin_answer'] = '%s (Admin) schreib am %s<br><br>%s';
...
$LNG['mod_info'] = 'Module im Game<br>Admins können weiterhin die Bereiche betreten!';
