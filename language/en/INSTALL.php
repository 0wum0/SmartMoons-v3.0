...
$LNG['intro_welcome']			= 'Hello user of SmartMoons!';
$LNG['intro_text']				= 'SmartMoons is a modern fork of 2Moons, one of the best projects of OGame.<br>SmartMoons is the newest and most stable version currently developed. SmartMoons is remarkable for its modern PHP 8.3 compatibility, PDO security, Twig templates, and futuristic Dark Sci-Fi interface. We always expect to be better than your expectations.<br><br>The installation system will guide you through the installation or upgrading from a previous version to the latest one. Each question, a problem, please dont hesitate to ask our development and support in case of doubt!<br><br>SmartMoons is an Open Source project, licensed under the MIT License. For this to be verified, please click the link above where it refers to "license"<br><br>Before the installation can be started a small test to see if your plan/domain has all the requirements to support SmartMoons';
$LNG['intro_upgrade_head']		= 'SmartMoons already installed?';
$LNG['intro_upgrade_text']		= '<p>You have already installed SmartMoons and want easy updating?</p><p>Here you can update your old database with just a few clicks!</p>';
...
$LNG['upgrade_required_rev']	= 'The Updater can work only from revision r2579 (SmartMoons v1.7) or later.';
...
$LNG['licence_accept']			= 'To continue the installation of SmartMoons, you need to agree to the terms and conditions of license of SmartMoons';
$LNG['licence_need_accept']		= 'If you want to continue with the installation, you must accept the terms of license';

$LNG['req_head']				= 'System requirements';
$LNG['req_desc']				= 'Before the installation proceed, SmartMoons will run some tests to verify that your server supports SmartMoons, so ensure that SmartMoons can be installed. It is suggested that you read carefully the results, and do not proceed until all these be checked.';
$LNG['reg_yes']					= 'Yes';
$LNG['reg_no']					= 'No';
$LNG['reg_found']				= 'Found';
...
$LNG['req_php_need_desc']		= '<strong>Required</strong> — PHP is the language code base of SmartMoons. This requires PHP version 8.3 or higher so that all modules work correctly';
...
$LNG['reg_global_desc']			= 'SmartMoons will also work, if this configuration is installed on your server. However, it is recommended for security reasons, disable "register_globals" in PHP installation, if that is possible.';
$LNG['req_ftp_head']			= 'Insert information of FTP';
$LNG['req_ftp_desc']			= 'Write your information from FTP so SmartMoons automatically fix problems. Alternatively, you can also manually assign permissions to write.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'User name';
$LNG['req_ftp_password']		= 'Password';
$LNG['req_ftp_dir']				= 'Directory of SmartMoons';
...
$LNG['step1_desc']				= 'Now that it has been determined that SmartMoons can be installed on your server, you should provide some information. If you dont know how to run a link database, contact your hosting provider first or with the SmartMoons forum for help and support. When you insert the data, checks were introduced properly';
...
$LNG['step3_desc']				= 'The tables needed for the SmartMoons database already have been created and populated with default values. To go to the next step, conclude the installation of SmartMoons';
...
$LNG['step6_desc']				= 'You installed with success the SmartMoons system';
$LNG['step6_info_head']			= 'Getting and using SmartMoons now!';
$LNG['step6_info_additional']	= 'If clicking the button below, you will be redirected to the page of administration. It will be a good advantage to explore SmartMoons administrator tools.<br/><br/><strong>Please delete the &raquo;includes/ENABLE_INSTALL_TOOL&laquo; or modify the filename. With the existence of this file, you can cause your game at risk by allowing someone rewrite the installation!</strong>';

$LNG['step8_need_fields']		= 'You must fill in all fields.';


$LNG['sql_close_reason']		= 'The game is closed';
$LNG['sql_welcome']				= 'Welcome to SmartMoons v';
